...
public class VideoCaptureDeviceInfoAndroid {
    ...
    CreateVideoCaptureDeviceInfoAndroid(int in_id, Context in_context) {
        ...
        if(self != null && self.Init() == 0) {
        	...
        	if(ViESurfaceRenderer.DEBUG){
        		ECLog4Util.d(TAG, "Failed to create VideoCaptureDeviceInfoAndroid.");
        	}
        }
        return null;
    }
            ...
            if(android.os.Build.VERSION.SDK_INT > 8) {
                ...
                for(int i = 0; i < Camera.getNumberOfCameras(); ++i) {
                    ...
                    if(info.facing == Camera.CameraInfo.CAMERA_FACING_BACK) {
                        ...
                        if(ViESurfaceRenderer.DEBUG){
                        	ECLog4Util.d(TAG, "Camera " + i +", Facing back, Orientation "+ info.orientation);
                    	}
                        ...
                        if(ViESurfaceRenderer.DEBUG){
                        	...
                        	ECLog4Util.d(TAG, "Camera " + i +", Facing front, Orientation "+ info.orientation);
                        }
                    }
        	 ...
        	 if(ViESurfaceRenderer.DEBUG){
        		 ...
        		 ECLog4Util.e(TAG, "Failed to init VideoCaptureDeviceInfo ex" +
    ...
    public VideoCaptureAndroid AllocateCamera(int id, long context,
        ...
        try {
        	 if(ViESurfaceRenderer.DEBUG){
        		 ...
        		 ECLog4Util.d(TAG, "AllocateCamera " + deviceUniqueId);
        	 }
            ...
            if(ViESurfaceRenderer.DEBUG){
            	ECLog4Util.v(TAG, "AllocateCamera - creating VideoCaptureAndroid");
            }
            ...
            return new VideoCaptureAndroid(id, context, camera, deviceToUse);
        	 ...
        	 if(ViESurfaceRenderer.DEBUG){
        		 ...
        		 ECLog4Util.e(TAG, "AllocateCamera Failed to open camera- ex " +
        				 ex.getLocalizedMessage());
        	 }
        }
        return null;
            ...
            try {
                ...
                // Nope - it did not work.
            	 if(ViESurfaceRenderer.DEBUG){
            		 ...
            		 ECLog4Util.e(TAG, "Init Failed to open front camera camera - ex " +
            				 ex.getLocalizedMessage());
            	 }
            }
        }
