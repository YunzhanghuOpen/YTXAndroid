...
public class ChattingListAdapter extends CCPListAdapter<ECMessage> {
    ...
    public ChattingListAdapter(Context ctx, ECMessage ecMessage, String user) {
     ...
     * @param ecMessage
     */
    public ChattingListAdapter(Context ctx, ECMessage ecMessage, String user, long thread) {
        super(ctx, ecMessage);
        mUsername = user;
        mThread = thread;
